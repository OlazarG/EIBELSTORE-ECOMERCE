...
console.log("CONTROLLER LOADED: productController [VERSION_FIX_UPLOADS]");
...
exports.updateProduct = async (req, res) => {
    ...
    try {
        ...
        const oldRes = await pool.query('SELECT * FROM products WHERE id = $1', [productId]);
        ...
        let gallery_urls = oldProduct.gallery_urls || [];
        ...
        res.status(500).json({ message: 'Error updating product', error: err.message, stack: err.stack });
    }
};
